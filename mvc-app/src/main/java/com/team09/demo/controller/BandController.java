...
public class BandController {
    ...
    public ResponseEntity<Band> getBandByEmail(@PathVariable String email) {
        Band band = bandService.getBandByEmail(email);
        return band != null ? ResponseEntity.ok(band) : ResponseEntity.notFound().build();
    }
}
