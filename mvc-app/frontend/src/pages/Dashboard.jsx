...
import { getBandById, getShowsByBand } from '../api'

const ACTIVITY = [
  { id: 1, text: 'Welcome to SceneScout — post your first show!', time: 'Just now', icon: 'users' },
  { id: 2, text: 'Complete your profile to attract more venues', time: '', icon: 'eye' },
  { id: 3, text: 'Go to Feed to post a concert', time: '', icon: 'calendar' },
]
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (!id) return
    getBandById(id).then(setBand).catch(() => {})
    getShowsByBand(id)
      .then((data) => {
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {[
                    ...
                    { label: 'Time', value: nextShow.showTime ? formatTime(nextShow.showTime.substring(0, 5)) : '—' },
